...
console.log("TODO 3 : Different Brand Names");
const BrandsName=[];
for(var k=0;k<marketplace.length;k++)
{
  BrandsName.push(marketplace[k].brand);
}

const uniqueBrandsName = [...new Set(BrandsName)];

for(let k=0;k<uniqueBrandsName.length;k++)
{
  console.log("Brand number "+(k+1).toString()+" : "+uniqueBrandsName[k].toString());
}
...
console.log('TODO 4 : ');
const Prices_Articles=[];
for(let k=0;k<marketplace.length;k++)
{
  Prices_Articles.push(marketplace[k].price);
}

const sortedPrices_Articles=Prices_Articles.sort(function(a, b) {
  return a - b;
});

const Products_Articles=[];

for(let k=0;k<sortedPrices_Articles.length;k++)
{
  for(let i=0;i<marketplace.length;i++)
  {
    if(sortedPrices_Articles[k]==marketplace[i].price)
    {
      Products_Articles.push(marketplace[i].name);
    }
  }
}
const uniqueProducts_Articles = [...new Set(Products_Articles)];

console.log("Sorted Products from the lower cost to the higher cost : ");
for(let k=0;k<uniqueProducts_Articles.length;k++)
{
  console.log("Product "+(k+1).toString()+" : "+uniqueProducts_Articles[k]+" | Price : "+sortedPrices_Articles[k].toString()+" €");
}
console.log(' ');
...
console.log('TODO 5 :');
const Dates_Articles=[];
for(let k=0;k<marketplace.length;k++)
{
  Dates_Articles.push(marketplace[k].released);
}

const sortedDates_Articles=Dates_Articles.sort();

const Products_Articles_Dates=[];

for(let k=0;k<sortedDates_Articles.length;k++)
{
  for(let i=0;i<marketplace.length;i++)
  {
    if(sortedDates_Articles[k]==marketplace[i].released)
    {
      Products_Articles.push(marketplace[i].name);
    }
  }
...
const uniqueProducts_Articles_Dates = [...new Set(Products_Articles_Dates)];

console.log("Sorted Products from the lower released date to the higher realesed date : ");
for(let k=0;k<uniqueProducts_Articles.length;k++)
{
  console.log("Product "+(k+1).toString()+" : "+uniqueProducts_Articles[k]+" | Realesed Date : "+sortedDates_Articles[k].toString());
}
console.log(' ');
...
console.log('TODO 6 :');
const sortedPrices_Articles_Between_50_and_100=[];
for(let k=0;k<sortedPrices_Articles.length;k++)
{
  if(sortedPrices_Articles[k]>=50 && sortedPrices_Articles[k]<=100)
  {
    sortedPrices_Articles_Between_50_and_100.push(sortedPrices_Articles[k]);
  }
}

const Products_Articles_Price_Between_50_and_100=[];

for(let k=0;k<sortedPrices_Articles_Between_50_and_100.length;k++)
{
  for(let i=0;i<marketplace.length;i++)
  {
    if(sortedPrices_Articles_Between_50_and_100[k]==marketplace[i].price)
    {
      Products_Articles_Price_Between_50_and_100.push(marketplace[i].name);
    }
  }
}

const uniqueProducts_Articles_Prices_Between_50_and_100 = [...new Set(Products_Articles_Price_Between_50_and_100)];

console.log("Sorted Products that costs between 50€ and 100€ : ");
for(let k=0;k<uniqueProducts_Articles_Prices_Between_50_and_100.length;k++)
{
  console.log("Product "+(k+1).toString()+" : "+uniqueProducts_Articles_Prices_Between_50_and_100[k]+" | Price : "+sortedPrices_Articles_Between_50_and_100[k].toString()+" €");
}
console.log(' ');
...
console.log('TODO 7 : Average price of the marketplace');
function AVG_MarketPlace()
{
  let S = new Number(0);
  let N = marketplace.length;
  for(let k=0;k<marketplace.length;k++)
  {
    S+=marketplace[k].price;
  }
  return S/N;
}
console.log("AVG PRICE : "+AVG_MarketPlace().toString()+" €")
console.log(' ');
